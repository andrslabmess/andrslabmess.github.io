---
title: "General protocol: Immunofluorescence"
date: 2025-01-31 
...
> ***Wash general*** <br>
>1. aspirate liquid
>1. add washing solution
>1. aspirate liquid <br>
>        …… repeat …… <br>
>1. add desire liquid <br>
{: .prompt-info }
...
* seed the cells to have approx. 70 % confluency (the next day or in the day of fixation); <br>
seeding HeLa, U2OS, DMF etc. 20 000 - 30 000 cells/cm<sup>2</sup>
<br>
...
> * when cells are attached or day of treatment: tranfer coverslips in individual wells <br>
{: .prompt-tip }
...
<ul style="list-style-type:none;">
    <li>❀ pre-warm: DMEM, PBS for treatment and CVs transfer to wells</li>
    <li>❀ prepared all materials, reagents, solutions and treatment</li>
</ul>

<br>

***Before IF or treatment*** <br>
***Transfer coverslips into well plate*** <br>
1. add pre-warm medium or PBS to each well
1. transfer CVs with tweezer
(if you can not lift it: try to lift if with P200 or P2 tip agains plate wall with one hand and grab it with tweezer in other hand)
1. ... continue with treatment/IF ...
...
❀ In mean time ❀
<ul style="list-style-type:none;">
    <li>❀ prepare wet chamber</li>
    <li>❀ dilute primary antibody</li>
</ul>
...
><br>
> Based on their excitation and emission spectrum
...
> Secondary antibody & samples have to be kept in dark from now on. 
> Use dark wet chamber for further staining and work.
{: .prompt-warning }
...
* wash CVs with H<sub>2</sub>O (dipinto H<sub>2</sub>O in beaker or dish/well)
...
> ***Mounting Guide***
>[Thermofisher: Overview of antifade mounting medium](https://www.thermofisher.com/cz/en/home/life-science/cell-analysis/cellular-imaging/fluorescence-microscopy-and-immunofluorescence-if/mounting-medium-antifades.html?ef_id=Cj0KCQjwkMjOBhC5ARIsADIdb3cmDWeaDWyWD_qcbz9C76mtwNKcBzEzx1Q-5T_jqpEd-Obwjp_I_UoaArCXEALw_wcB:G:s&s_kwcid=AL!3652!3!447292198778!!!g!!!10506731179!109642167811&cid=bid_pca_iva_r01_co_cp1359_pjt0000_bid00000_0se_gaw_dy_pur_con&gad_source=1&gad_campaignid=10506731179&gbraid=0AAAAADxi_GTYuSLpAE1nPYAGR2Tv_nJat&gclid=Cj0KCQjwkMjOBhC5ARIsADIdb3cmDWeaDWyWD_qcbz9C76mtwNKcBzEzx1Q-5T_jqpEd-Obwjp_I_UoaArCXEALw_wcB)
>
>[Vectorlabs: Immunofluorescence Mounting Guide](https://cdn.chromspec.com/content/ve46.pdf)
{: .prompt-info }
