...
> CldU stock (5mg/mL= 19mM dilluted in dH2O); working concentration 3 μL CldU / 1 mL media
> IdU stock  10mg/ml = 28,24 mM in DMSO or water + a few drops of 10M NaOH, until it dissolves
> addition of IdU should not change the color of media

* seed cells on 6WP to be at  ̴̴70% confluence – before additing drug
* optional: wash with pre-warm PBS
* add 3 μL CldU (stock) to 1 mL medium
* incubation (30 min (or as needed), 37°C; 6% CO<sub>2</sub>)
* wash with pre-warm PBS (3x)
* add 1mL fresh medium + 12 μl IdU stock/1mL of fresh media
* incubation (30 min (or as needed), 37°C; 6% CO<sub>2</sub>)
* wash 2x with pre-warm PBS
* harvest cells with 400 μl trypsin
* add 1mL of media
* transfer to epp tube, 
...
* option: Prepare one special plate, which will be unlabelled cells.
